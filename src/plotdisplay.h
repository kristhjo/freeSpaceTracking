...
struct savingSettings{
    ...
    savingSettings(QString file_name, QString folder_path = "", bool save_plot = true, QString type_name = "png", int x_dim = 1200, int y_dim = 600)
        : save_plot(save_plot), file_name(file_name), folder_path(folder_path), type_name(type_name), x_dim(x_dim), y_dim(y_dim){}
    bool save_plot;
    QString file_name;
    QString folder_path;
