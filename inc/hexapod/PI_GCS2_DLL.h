...
BOOL    PI_FUNC_DECL    PI_GetAvailableControllerConfigurationsFromDatabaseByType(int ID, char* szConfigurationNames, int configurationNamesBufferSize, unsigned int configurationType);

/////////////////////////////////////////////////////////////////////////////
// PIRest commands
BOOL PI_FUNC_DECL PI_POL (int ID, const char* szAxes, const int* iValueArray);
