...
private:
   ...
   // QDir baseDirectory; ///< directory structure of directoryPath.
    ...
    QCPColorMap *colorMapImage;
    QCPColorMap *colorMapFit;
    QCPColorMap *colorMapResidue;
    QCPColorScale *colorScaleImage;
    QCPColorScale *colorScaleFit;
    QCPColorScale *colorScaleResidue;

    QCPBars *saturatedPixels_hist;
    QVector<double> pixelsIndex;
    QVector<double> sumSaturatedPixels;
private slots:
    ...
    void debugGaussian(cv::Mat image);
    void setWindowRadius();
    void replotHistogram(int numSaturatedPixels);
    //void setAiryMin();
signals:
    ...
    void debugGaussianSeeing(cv::Mat image);
    void updateHistogram(int numSaturatedPixels);
};
