/****************************************************************************
** Meta object code from reading C++ file 'cameragui.h'
**
...
#include "../src/cameragui.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'cameragui.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 10, 8), // "newImage"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 14) // "updateCamImage"

    },
    "CameraGui\0newImage\0\0updateCamImage"
};
...
void CameraGui::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->updateCamImage(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraGui::newImage)) {
                *result = 0;
                return;
            }
        }
