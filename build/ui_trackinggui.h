...
public:
    ...
    QTextEdit *TE_LogCam;
    QGridLayout *gridLayout_Hedy;
    QPushButton *PB_ConnectHedyLamarr;
    QPushButton *PB_DisconnectHedyLamarr;
    QPushButton *PB_StopHedyLamarrStabilization;
    QPushButton *PB_StartHedyLamarrStabilization;
    ...
    void setupUi(QMainWindow *TrackingGui)
    {
        ...
        gridLayout_Hedy = new QGridLayout();
        gridLayout_Hedy->setSpacing(6);
        gridLayout_Hedy->setObjectName(QString::fromUtf8("gridLayout_Hedy"));
        PB_ConnectHedyLamarr = new QPushButton(centralWidget);
        PB_ConnectHedyLamarr->setObjectName(QString::fromUtf8("PB_ConnectHedyLamarr"));

        gridLayout_Hedy->addWidget(PB_ConnectHedyLamarr, 0, 0, 1, 1);

        PB_DisconnectHedyLamarr = new QPushButton(centralWidget);
        PB_DisconnectHedyLamarr->setObjectName(QString::fromUtf8("PB_DisconnectHedyLamarr"));

        gridLayout_Hedy->addWidget(PB_DisconnectHedyLamarr, 0, 1, 1, 1);

        PB_StopHedyLamarrStabilization = new QPushButton(centralWidget);
        PB_StopHedyLamarrStabilization->setObjectName(QString::fromUtf8("PB_StopHedyLamarrStabilization"));

        gridLayout_Hedy->addWidget(PB_StopHedyLamarrStabilization, 1, 1, 1, 1);

        PB_StartHedyLamarrStabilization = new QPushButton(centralWidget);
        PB_StartHedyLamarrStabilization->setObjectName(QString::fromUtf8("PB_StartHedyLamarrStabilization"));

        gridLayout_Hedy->addWidget(PB_StartHedyLamarrStabilization, 1, 0, 1, 1);


        gridLayout_3->addLayout(gridLayout_Hedy, 4, 1, 1, 1);
        ...
        gridLayout_3->addLayout(gridLayout_Hexapod, 4, 0, 1, 1);
        ...
        gridLayout_CamSettings->addWidget(HS_Height, 3, 1, 1, 2);
        ...
        gridLayout_CamSettings->addWidget(HS_OffsetY, 5, 1, 1, 2);
        ...
        gridLayout_CamSettings->addWidget(SB_ExposureCam, 0, 3, 1, 1);

        Label_Height = new QLabel(centralWidget);
        Label_Height->setObjectName(QString::fromUtf8("Label_Height"));

        gridLayout_CamSettings->addWidget(Label_Height, 3, 0, 1, 1);
        ...
        gridLayout_CamSettings->addWidget(HS_OffsetX, 4, 1, 1, 2);
        ...
        gridLayout_CamSettings->addWidget(SB_Width, 2, 3, 1, 1);

        SB_OffsetY = new QSpinBox(centralWidget);
        SB_OffsetY->setObjectName(QString::fromUtf8("SB_OffsetY"));

        gridLayout_CamSettings->addWidget(SB_OffsetY, 5, 3, 1, 1);
        ...
        gridLayout_CamSettings->addLayout(horizontalLayout, 1, 0, 1, 1);
        ...
        gridLayout_CamSettings->addWidget(SB_FrameRate, 1, 3, 1, 1);

        Label_FrameRate = new QLabel(centralWidget);
        Label_FrameRate->setObjectName(QString::fromUtf8("Label_FrameRate"));

        gridLayout_CamSettings->addWidget(Label_FrameRate, 1, 2, 1, 1);


        gridLayout_Cam->addLayout(gridLayout_CamSettings, 6, 0, 1, 2);
        ...
        gridLayout_Cam->addItem(verticalSpacer_2, 2, 0, 1, 2);


        gridLayout_3->addLayout(gridLayout_Cam, 0, 0, 1, 1);

        verticalSpacer_3 = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout_3->addItem(verticalSpacer_3, 3, 0, 1, 2);
    ...
    void retranslateUi(QMainWindow *TrackingGui)
    {
        ...
        PB_ConnectHedyLamarr->setText(QApplication::translate("TrackingGui", "Connect Hedy Lamarr", nullptr));
        PB_DisconnectHedyLamarr->setText(QApplication::translate("TrackingGui", "Disconnect Hedy Lamarr", nullptr));
        PB_StopHedyLamarrStabilization->setText(QApplication::translate("TrackingGui", "Stop stabilization", nullptr));
        PB_StartHedyLamarrStabilization->setText(QApplication::translate("TrackingGui", "Start stabilization", nullptr));
